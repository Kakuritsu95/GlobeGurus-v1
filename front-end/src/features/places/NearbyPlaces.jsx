    ...
    <div className="mx-auto h-[60vh] w-11/12 overflow-auto bg-zinc-200 md:w-full">
      <ul className="space-y-2">
        {nearbyPlaces.map((place) => (
          <li
            key={place.coords[0]}
            className={`rounded border border-gray-200 bg-white p-2 2xl:flex dark:border-gray-700 dark:bg-gray-800 ${place === selectedPlace ? "bg-blue-200" : "bg-white"} shadow-lg xl:h-64 xl:space-x-5`}
          >
